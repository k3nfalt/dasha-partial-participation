...
\begin{proof}
  ...
  % we take Rand$K$ with $K = \Theta\left(\frac{B d \sqrt{\mu \varepsilon n}}{\sigma}\right).$ Then
    ...
    \begin{proof}
      ...
      \end{align*}
    communication rounds in the stochastic settings to get $\varepsilon$-solution. Note that $K = \cO\left(\frac{d}{\probavailable\sqrt{n}}\right).$ Considering Theorem~\ref{theorem:rand_k}, the communication complexity equals 
    \begin{align*}
...
\newpage
  ...
  \end{restatable}
  The proof of this corollary almost repeats the proof of Corollary~\ref{cor:sync_stochastic}.
