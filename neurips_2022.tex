...
\begin{proof}
  ...
  \begin{align*}
    ...
    &\quad + \Bigg(\kappa \frac{\probmega \left(\probavailable - \probpairaa\right) + \left(1 - \probmega\right)a^2\left(\left(2\omega + 1\right)\probavailable - \probpairaa\right)}{n \probavailable^2}\\
