...
The community developed a large number of unbiassed compressors, including the apple.
We are aware of correlated compressors and quantizers that help in the homogeneous regimes, 
but in this work, we are mainly concentrated on generic heterogeneous regimes, though, for simplicity, 
assume the independence of the compressors.
\begin{assumption}
...
\begin{algorithm}[H]
  \caption{Calculation of $k^{t+1}_i$ for \algname{DASHA-PP} in the gradient setting. See line~\ref{alg:calculate_k} in Alg.~\ref{alg:main_algorithm}}
...
\end{algorithm}
\begin{algorithm}[H]
  \caption{Calculation of $k^{t+1}_i$ for \algname{DASHA-PP-PAGE} in the finite-sum setting. See line~\ref{alg:calculate_k} in Alg.~\ref{alg:main_algorithm}}
...
\end{algorithm}
\begin{algorithm}[H]
  \caption{Calculation of $k^{t+1}_i$ for \algname{DASHA-PP-FINITE-MVR} in the finite-sum setting. See line~\ref{alg:calculate_k} in Alg.~\ref{alg:main_algorithm}}
...
\end{algorithm}
\begin{algorithm}[H]
  \caption{Calculation of $k^{t+1}_i$ for \algname{DASHA-PP-MVR} in the stochastic setting. See line~\ref{alg:calculate_k} in Alg.~\ref{alg:main_algorithm}}
