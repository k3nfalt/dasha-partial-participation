...
and independent participation, where each node independently participates with probability $\probavailable$ (due to independence $\probpairaa = \probavailable^2$), satisfy the assumption.
