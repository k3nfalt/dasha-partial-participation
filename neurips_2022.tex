...
% \begin{corollary}
  ...
  \end{align*}
\end{restatable}
Up to Lipschitz constants and probability $\probavailable$ factor, \algname{(\algorithmname-MVR)} has the state-of-the-art oracle complexity under P\L-condition (see \citep{PAGE}).
