...
\begin{table*}
  ...
  \begin{threeparttable}
    ...
    \begin{tablenotes}
      ...
      \item [{\color{blue}(b)}] On average, \algnamesmall{MARINA} provides the compressed communication mechanism with complexity $\cO\left(\frac{d}{\sqrt{n} \varepsilon}\right).$ However, with a small probability, this method sends non-compressed vectors.
