...
In Figures~\ref{fig:stoch-real-sim} and \ref{fig:stoch-sum-mnist}, we consider the stochastic setting. We can see that \algname{DASHA-PP} convergences to low accuracy solutions, unlike \algname{FRECON}. Also, \algname{DASHA-PP} improves \algname{MARINA}.
