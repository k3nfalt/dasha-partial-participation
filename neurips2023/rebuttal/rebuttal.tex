...
% \end{center}
\vspace{-0.3cm}
{2. \bf Stochastic Setting.} In Figures~\ref{fig:stoch-real-sim} and \ref{fig:stoch-sum-mnist}, we consider the stochastic setting. We can see that \algname{DASHA-PP} convergences to low accuracy solutions, unlike \algname{FRECON}. Moreover, \algname{DASHA-PP} improves the convergence rates of \algname{MARINA}.
