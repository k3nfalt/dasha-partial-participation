...
In this experiments, we compare our new algorithm \algname{DASHA-PP} with previous baselines \algname{MARINA} and \algname{FRECON} in the partial participation setting.
...
We do have experiments with \algname{FRECON} because the corresponding authors do not consider \algname{FRECON} in the finite-sum setting.
