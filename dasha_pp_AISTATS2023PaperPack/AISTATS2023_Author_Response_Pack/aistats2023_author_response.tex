...
3. This part is indeed can be confusing. We mean that the compressors are \emph{statistically} independent. In other words, $\cC_1(x_1), \dots, \cC_n(x_n)$ are independent random vectors for all $x_1, \dots, x_n \in \R^d$.
...
2.a If you read papers from Tables 1 and 2, you will find that virtually all of them extend the theory from some previous papers. The research on the optimization methods is incremental. It is not very obvious why it is a weakness of our paper and not others. 

2.b Our assumptions are general and not stronger than the assumptions of methods from Tables 1 and 2. Our analysis is independent and requires additional mathematical techniques that we provide in our proofs.
