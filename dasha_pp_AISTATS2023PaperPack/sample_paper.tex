...
\begin{table*}[!ht]
  \caption{Summary of methods that solve the problem \eqref{eq:main_problem} in the finite-sum setting \eqref{eq:task_minibatch}. Abbr.: \emph{VR} (Variance Reduction) = Does a method have the optimal oracle complexity $\cO\left(m + \frac{\sqrt{m}}{\varepsilon}\right)$?}
