...
\begin{table*}
  \caption{The comparison of methods that solve the problem \eqref{eq:main_problem} in the stochastic setting \eqref{eq:task_staochastic}.}
  ...
  \begin{threeparttable}
    ...
    \emph{PP} & \emph{CC} & Limitations \\
     ...
     \midrule
     \begin{tabular}{@{}c@{}} Naive \algname{STORM} in the \emph{PP} setting \end{tabular} & \cmark & \cmark & \xmark & \\
     \midrule
     \begin{tabular}{@{}c@{}}\algname{MARINA} \\ \citep{MARINA} \end{tabular} & \cmark & \xmark\textsuperscript{{\color{blue}(a)}} & \tablenote\textsuperscript{{\color{blue}(b)}} & \begin{tabular}{@{}c@{}}Suboptimal convergence rate \\ (see \citep{tyurin2022dasha}). \end{tabular}\\
     \midrule
...
\item [{\color{blue}(b)}] On average, \algname{MARINA} provides the compressed communication mechanism. However, with a small probability, this method sends non-compressed vectors.
