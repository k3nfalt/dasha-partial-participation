...
\icmltitlerunning{A Computation and Communication Efficient Method in the Partial Participation Setting}
...
\begin{table*}[!ht]
  ...
  \begin{threeparttable}
    ...
    \begin{tablenotes}
      ...
      \item [{\color{blue}(c)}] Note that \algname{MIME} and \algname{CE-LSGD} can not be directly compared with \algname{DASHA-PP} because \algname{MIME} and \algname{CE-LSGD} consider the online version of the problem \eqref{eq:main_problem}, and requires more strict assumptions.
